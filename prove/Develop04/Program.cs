    ...
    static void Main(string[] args)
    {
        ...
        while (input != 4)
        {
            ...
            if (input == 1)
            {
                ...
                "\nThis activity will help you to relax and clear your mind by bretahing slowly.\n", "\nHow long,in seconds would you like for your session\n");
            ...
            else if (input == 3)
            {
                ...
                "\nListing activity will help you reflect on good things in your life. List as many as you can.\n", "\nHow long,in seconds would you like for your session\n");
